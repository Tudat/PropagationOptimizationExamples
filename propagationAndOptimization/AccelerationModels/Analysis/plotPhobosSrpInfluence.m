...
perturbedPhobos = load(strcat(dataFolder,'phobosPropagationHistorySrp0.dat'));
unperturbedPhobos = load(strcat(dataFolder,'phobosPropagationHistorySrp1.dat'));
...
%%
perturbedKeplerPhobos = load(strcat(dataFolder,'phobosPropagationKeplerianHistorySrp0.dat'));
unperturbedKeplerPhobos = load(strcat(dataFolder,'phobosPropagationKeplerianHistorySrp1.dat'));
