...
dataFolder = '../../SimulationOutput/AccelerationModels/';

lunarOrbitWithoutMutualSphericalHarmonics = load(strcat(dataFolder,'moonMutualGravitationalAttractionInfluence_0.dat'));
lunarOrbitWithMutualSphericalHarmonics = load(strcat(dataFolder,'moonMutualGravitationalAttractionInfluence_1.dat'));

figure(1)

orbitDifference = lunarOrbitWithoutMutualSphericalHarmonics - lunarOrbitWithMutualSphericalHarmonics;
plot(lunarOrbitWithoutMutualSphericalHarmonics(:,1)/86400,orbitDifference(:,2:4))
...
title('Direct influence of mutual gravitational interaction on Moon position')
