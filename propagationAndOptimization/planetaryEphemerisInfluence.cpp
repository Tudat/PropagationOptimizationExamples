...
int main()
{
    std::string outputDirectory = tudat_applications::getOutputPath( "EnvironmentModelsLunarOrbiterInfluence/" );
    ...
    spice_interface::loadSpiceKernelInTudat( input_output::getSpiceKernelPath( ) + "mar097short.bsp" );
