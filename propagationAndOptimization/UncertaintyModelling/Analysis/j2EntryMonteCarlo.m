...
nominalState = load(strcat(dataFolder,'entryJ2SensitivityNominalTrajectory.dat'));
...
for i=1:numberOfSamples
    i
    perturbedStates{i,1} = load(strcat(dataFolder,'entryJ2SensitivityPerturbedTrajectory',num2str(i-1),'.dat'));
