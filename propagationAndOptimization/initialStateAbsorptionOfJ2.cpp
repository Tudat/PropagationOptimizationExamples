...
int main( )
{
    std::string outputPath = "ApolloCapsuleSphericalHarmonicsInfluence";
...

    {
        ...
        for( unsigned int i = 0; i < 10000; i++ )
        {
            ...
            input_output::writeDataMapToTextFile(
                        ...
                        "entryJ2SensitivityPerturbedTrajectory" + boost::lexical_cast< std::string >( i ) + ".dat" );
            input_output::writeMatrixToFile( statePerturbation, "entryJ2SensitivityPerturbation" + boost::lexical_cast< std::string >( i ) + ".dat" );
