...
unperturbedSatellite = load('singleUnperturbedSatellitePropagationKeplerianHistory.dat');
...
%%
perturbedSatelliteKepler = load('singlePerturbedSatellitePropagationKeplerianHistory.dat');
...
%%
perturbedSatelliteKepler = load('singlePerturbedSatellitePropagationMeeHistory.dat');
